...
import slider2 from "../../assets/pf1.png";
import slider3 from "../../assets/pf2.png";
...
const Parquet = ({base}) => {
  ...
  return (
    ...
    <h1 className="flex flex-col lg:flex-row  justify-center px-4 py-10 -mb-14 text-3xl font-extrabold underline underline-offset-8  ">Finger Jointed Board</h1>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr>
                ...
                <td className="border-b border-gray-300 p-2"> 15 & 18 mm</td>
              </tr>
              <tr>
                <td className="border-b border-gray-300 p-2">Width</td>
                <td className="border-b border-gray-300 p-2">70 to 90 mm</td>
              </tr>
              <tr>
                <td className="border-b border-gray-300 p-2">Length</td>
                <td className="border-b border-gray-300 p-2"> 1 to 3 feet</td>
              </tr>
              {/* <tr>
