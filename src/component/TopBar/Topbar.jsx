...
const Topbar = ({ base }) => {
  ...
  const getSubMenu = (parentId) =>
    menuData.filter((menu) => menu.parent_id === parentId);

  return (
    <header className=" bg-white text-black sticky top-0 z-50 flex justify-between px-4 lg:px-8 max-w-7xl mx-auto  sm:px-6 ">
      {/* Logo */}
      {headerInfo.map((head, index) => (
        ...
        //       alt="Logo"
        //       className="w-24 md:w-20 rounded-full"
        //     />
           ...
           <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
               <img
                src={`${base}/assets/uploads/${head.left_logo}`}
                alt="Logo"
                className="w-32  h-auto rounded bg-transparent "
              />
            </Link>
          </div>
          ...
          .map((menu) => (
            ...
            >
              <Link
                ...
                className="flex items-center space-x-1 hover:text-[#00b1a8] text-black"
              >
      ...
      {/* Mobile Menu */}
      {navOpen && (
        <div className="md:hidden fixed top-0 left-0 w-full h-full bg-white bg-opacity-90 z-10">
          <div className="p-4">
            <button
              onClick={handleNavToggle}
            ...
            <ul className="space-y-4 text-black text-center uppercase font-semibold mt-16">
              {menuData
                .filter((menu) => menu.parent_id === "0")
                .map((menu) => (
                  <li key={menu.id_menu}>
...
// import React, { useState } from 'react';
// import { Link } from 'react-router-dom';
// import Logo from "../../assets/nepwoodlogo.png";
// const pages = [
//   { name: 'About Us', link: 'about-us' },
//   { name: 'Products', link: '#' },
//   { name: 'Industries Served', link: '#', hasSubmenu: true },
...
//       <div className="max-w-9xl mx-auto px-4  items-center sm:px-6 lg:px-8">
...
//                       <path d="M5.23 7.21a.75.75 0 011.05.02l2.72 2.92 2.72-2.92a.75.75 0 011.05-.02.75.75 0 01-.02 1.05L9.5 10.8a.75.75 0 01-1.06 0L5.21 8.26a.75.75 0 01-.02-1.05z" />
//                     </svg>
//                   </button>
//                   <div
//                     className={`absolute left-0 mt-2 w-48 bg-white text-black rounded-md shadow-l py-2 ${
//                       isSubmenuOpen ? 'block' : 'hidden'
//                     }`}
//                   >
//                     {subpages.map((subpage) => (
...
//                         key={subpage.name}
//                         to={subpage.link}
//                         className="block px-4 py-2 hover:bg-gray-200 text-sm md:text-base"
//                       >
//                         {subpage.name}
//                       </Link>
//                     ))}
...
//                   key={page.name}
//                   to={page.link}
//                   className="block px-3 py-2 hover:text-gray-300 text-sm md:text-base"
//                 >
//                   {page.name}
//                 </Link>
//               )
