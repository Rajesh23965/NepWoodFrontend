...
import slider2 from "../../assets/p1.png";
import slider3 from "../../assets/p2.png";

import axios from "axios";

const sliderImages = [slider1, slider2, slider3];

const PlanedPine = ({base}) => {
  ...
  return (
    ...
    <h1 className="flex flex-col lg:flex-row  justify-center px-4 py-10 -mb-14 text-3xl font-extrabold underline underline-offset-8  ">Planed Pinewood Planks</h1>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr>
                ...
                <td className="border-b border-gray-300 p-2"> 25 & 32 mm</td>
              </tr>
              <tr>
                <td className="border-b border-gray-300 p-2">Width</td>
                <td className="border-b border-gray-300 p-2">6 to 12 inches</td>
              </tr>
              <tr>
                <td className="border-b border-gray-300 p-2">Length</td>
                <td className="border-b border-gray-300 p-2">6 to 9 feet</td>
              </tr>
              {/* <tr>
